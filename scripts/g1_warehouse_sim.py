...
parser.add_argument(
    ...
    help="Mid-360 emitter-state profiles, generated by scripts/gen_mid360_rtx_config.py.",
)
...
def main() -> None:
    ...
    prim_paths = spawn_mid360(
        ...
        # -2cm Z offset tested 2026-08-11 to rule out self-occlusion against
        # the mount mesh: made coverage strictly worse (0 hits vs a handful),
        # evidence against that theory. Reverted to identity/on-mount.
